<div class="catalog_wrapper">
    ...
    <form class="feedback_form" action="/models/feedback.php?action=create" method="post">
        ...
        <p>Оставьте отзыв:</p>
        <input type="text" maxlength="250" name="name" placeholder="Ваше имя" />
        <input type="text" maxlength="250" name="message" placeholder="Ваш отзыв" />
        ...
        <?php foreach ($feedback as $review): ?>
            <form class="feedback_entry">
                ...
                <div class="feedback_message">
                    <textarea maxlength="250" name="message" rows="3"><?= $review['contents'] ?></textarea>
                </div>
